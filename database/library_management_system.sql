...
CREATE TABLE IF NOT EXISTS membership_plans (
  ...
  monthly_fee DECIMAL(10,2) NOT NULL, borrowing_limit INT UNSIGNED NOT NULL DEFAULT 3,
  loan_days INT UNSIGNED NOT NULL DEFAULT 14, is_active TINYINT(1) NOT NULL DEFAULT 1,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB;
