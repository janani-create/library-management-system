...
-- 1. Users Table (Administrators, Librarians, Members)
...
-- 6. Book Returns Table (Audit & Fine Settlement Log)
...
-- Users (Default Admin: admin@library.com / admin123, Librarian: librarian@library.com / librarian123)
...
-- Book Issues (Sample active, returned, and overdue records)
